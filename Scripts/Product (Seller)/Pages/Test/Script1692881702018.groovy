...
WebUI.setText(findTestObject('Page_User Login/fieldEmailLogin'), 'tatag123@gmail.com')

WebUI.setText(findTestObject('Page_User Login/fieldPassLogin'), 'tatag123')

WebUI.click(findTestObject('Page_User Login/buttonLogin'))
