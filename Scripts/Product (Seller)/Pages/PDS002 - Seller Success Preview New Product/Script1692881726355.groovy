...
WebUI.callTestCase(findTestCase('Product (Seller)/Step Definition/Seller Fill New Product Description'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Product (Seller)/Step Definition/Seller Click Preview'), [:], FailureHandling.STOP_ON_FAILURE)
