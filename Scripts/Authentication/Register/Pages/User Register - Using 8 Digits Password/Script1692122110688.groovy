...
WebUI.callTestCase(findTestCase('Authentication/Register/Step Definition/User Register - Input Field Email (8 Digits Case)'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Authentication/Register/Step Definition/User Register - Input Field Password (8 Digits Case)'), 
    [:], FailureHandling.STOP_ON_FAILURE)
